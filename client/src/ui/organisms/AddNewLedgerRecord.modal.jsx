...
export const AddNewLedgerRecordModal = ({ type, open, handleOpen, handleClose, handleSubmit, ...props }) => {
    ...
    if (type === "EXPENSE") return (<MoneyManageModal title={"Dodaj wydatek"} description={"Dodawanie wydatków / test text"} handleClose={handleClose} handleSubmit={handleSubmit} />)
}
