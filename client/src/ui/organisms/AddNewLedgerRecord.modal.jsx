...
if(type === "INCOME") {
    return (
    <Modal open = {open} onClose = {onClose} modalTitle='Dodaj wpływ' description = 'Description'>
...
if(type === "EXPENSE") {
    ...
    return (
    <Modal open = {open} onClose = {onClose} modalTitle='Dodaj wydatek' description = 'Description'>
